...
customer\_id,first\_name,last\_name,email,phone,address
...
food\_id,name,price,category,availability
...
order\_id,customer\_id,food\_id,quantity,order\_date,status,total\_amount
...
| food\_id      | Ordered Food Item      |

| quantity     | Quantity Ordered       |

| order\_date   | Date and Time of Order |

| status       | Order Status           |

| total\_amount | Total Bill Amount      |
...
Task 1:Create a Virtual Warehouse named SALES\_WH.



Task 2:Create a Database named CUSTOMER\_SALES\_DB.



Task 3:Create a Schema named SALES\_SCHEMA.
...
Task 6:Create an Internal Stage named SALES\_STAGE to store the CSV files.
...
Task 23:Create a View named CUSTOMER\_SALES\_REPORT containing:
