...
difficult to generate analytical reports directly from the operational databases. Complex business queries take a long time to execute, and decision-makers are unable to obtain timely insights into sales performance, customer behavior, and product demand.
...
| FACT\_SALES | Stores every sales transaction |
...
One row in FACT\_SALES represents one product purchased by one customer from one branch on one specific date.
...
DIM\_CUSTOMER 1 ---- \* FACT\_SALES

DIM\_PRODUCT 1 ---- \* FACT\_SALES

DIM\_BRANCH 1 ---- \* FACT\_SALES

DIM\_DATE 1 ---- \* FACT\_SALES
