...
Create a Warehouse named RETAIL\_WH.

Create a Database named RETAIL\_DB.

Create a Schema named SALES\_SCHEMA.
...
Display the top-selling product in each category using ROW\_NUMBER().
...
Create a View named SALES\_REPORT.

Create a Materialized View named TOP\_CUSTOMERS.
