...
customer\_id,customer\_name,city,membership
...
sale\_id,customer\_id,product\_id,branch\_id,quantity,sale\_date,total\_amount
...
1.Create Warehouse ENTERPRISE\_WH

2.Create Database ENTERPRISE\_DB

3.Create Schema SALES\_SCHEMA
...
8.Load sales\_history.csv into SALES table.
...
21.Create a clone named: SALES\_TEST
...
38.Create View: CUSTOMER\_REVENUE

39.Create Materialized View: BRANCH\_REVENUE
